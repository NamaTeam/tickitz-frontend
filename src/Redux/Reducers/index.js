...
import { AllMovies, FetchMovieNow, FetchUpcomingMovie, FetchMovieById, FetchMoviesByMonth } from './movie'
...
const reducers = combineReducers({
    ...
    FetchCinemaByLocation, GetOrderById, UpdateOrder, GetOrderHis, FetchMoviesByMonth, AllCinema, allStats
})
