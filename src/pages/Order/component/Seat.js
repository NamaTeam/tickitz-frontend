...
const Seat = ({ schedule, id }) => {
  ...
  const addSelectedSeat = (e) => {
    ...
    setDataOrder({
      ...dataOrder,
      schedule_id: schedule.id,
      seat: [...dataOrder.seat, e.target.id],
    });
  };
  ...
  useEffect(() => {
    ...
    setDataOrder({
      ...dataOrder,
      total: `${dataOrder.seat.length * schedule.price}`,
    });
  }, [dataOrder.seat]);
        ...
        <div className="col-12 col-lg-8">
          ...
          <div className="card mt-3 card-seats">
            <div className="cinema-theatre mb-5">
              ...
              <p
                className="text-danger my-3 fw-bold ms-5 reset-seat"
                onClick={() => reset()}
              >
                Reset Selected
              </p>
          ...
          <div className="d-flex justify-content-between mt-5 mx-4">
            <button className="btn btn-rounded px-5 py-2 bg-white btn-change-movie">
              Change your movie
            </button>
            <button
              className="btn btn-rounded px-5 py-2 btn-checkout"
        ...
        <div className="col-12 mt-3 mt-lg-0 col-lg-4">
          ...
          <div className="card border-0 mt-5 px-4 order-info">
            <img
              ...
              src={`${process.env.REACT_APP_API_IMG_URL}${schedule.logo}`}
              alt=""
            ></img>
            ...
            <div className="d-flex justify-content-between pt-4 pb-3 mt-4 total-payment">
              ...
              <p className="price">{`Rp. ${
                schedule.price * dataOrder.seat.length
              }`}</p>
            </div>
          </div>
        </div>
